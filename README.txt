...
a persistence unit "demo.upsPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "demo.ups/pom.xml":
...
artifact ("demo.ups.war") is already built. You can build
